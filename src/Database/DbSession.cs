...
namespace DataBase
{
    ...
    public class DbSession : TrackableObject, ISession, IConfigurable
    {
        ...
        {
            if (taskElementExecution is not TaskElementDomain taskElementDomain)
            {
                throw new ArgumentException(nameof(taskElementExecution));
            }
        ...
        public void RemoveTimeInterval(ITimeIntervalElement timeIntervalElement,
            ITaskElementExecution taskElementExecution)
        {
            taskElementExecution.TimeIntervals.Remove(timeIntervalElement);
            var timeIntervalElementEntity = _timeIntervalMapper.MapBack(timeIntervalElement);
