...
Для развития этого проекта предполагается в будущем выполнение следующих задач:

- [ ] Добавление новых, более сложных моделей обучения
- [ ] Оптимизация обучения моделей
- [ ] Возможность настройки обучения моделей
- [ ] Использование машинного обучения для решения дополнительных задач
- [ ] Возможность более гибкой настройки самого приложения
- [ ] Повторяющие задачи для автоматизации рутинных процессов
- [ ] Интеграция с другими онлайн-сервисами для управления задачами
- [ ] Онлайн-сервис для хранения и обработки данных
- [ ] Доработка элемента управления календаря
- [ ] Доработка тестов
